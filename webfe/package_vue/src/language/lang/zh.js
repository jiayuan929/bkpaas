...
export default {
  ...
  '请输入应用所在子目录，并确保 Procfile 文件在该目录下，不填则默认为根目录': '请输入应用所在子目录，并确保 Procfile 文件在该目录下，不填则默认为根目录',
  编辑源码仓库: '编辑源码仓库',
  切换源码仓库: '切换源码仓库',
  镜像管理: '镜像管理',
  ...
  '格式不正确，由小写字母组成，长度小于 20 个字符': '格式不正确，由小写字母组成，长度小于 20 个字符',
  '由小写字母组成，长度小于 20 个字符': '由小写字母组成，长度小于 20 个字符',
  ...
  '请输入 3-20 字符的小写字母、数字、连字符(-)，以小写字母开头': '请输入 3-20 字符的小写字母、数字、连字符(-)，以小写字母开头',
  ...
  更换默认密钥: '更换默认密钥',
  禁用密钥: '禁用密钥',
  '禁用此密钥后，蓝鲸云 API 将拒绝此密钥的所有请求。禁用后，预计 15 分钟内生效。': '禁用此密钥后，蓝鲸云 API 将拒绝此密钥的所有请求。禁用后，预计 15 分钟内生效。',
  删除密钥: '删除密钥',
  ...
  '密钥已达到上限，应用仅允许有 2 个密钥': '密钥已达到上限，应用仅允许有 2 个密钥',
  ...
  暂无钩子命令: '暂无钩子命令',
  '钩子命令在 app_desc.yaml 文件中定义。': '钩子命令在 app_desc.yaml 文件中定义。',
