...
class TestAppOperationRecord:
    @pytest.mark.parametrize(
        ("target", "operation", "attribute", "module_name", "environment", "result_code", "expected"),
        [
            (
                OperationTarget.APP,
    ...
    def test_opreation_record_display(
        self, bk_app, bk_user, operation, target, attribute, module_name, environment, result_code, expected
    ):
